...
def Result():
    ...
    i = mode.get()
    if i == 1:
        Output.set(encode(k, msg_text))
    elif i == 2:
        Output.set(decode(k, msg_text))
    else:
        messagebox.showinfo('MINI PROJECT', 'Please choose either encryption or decryption.')
